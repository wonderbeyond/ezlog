...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_entry', 'views', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Entry.views'
        db.alter_column('blog_entry', 'views', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'blog.category': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "u'\\u672a\\u5206\\u7c7b'", 'unique': 'True', 'max_length': '100'})
        },
        'blog.entry': {
