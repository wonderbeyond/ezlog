...
Attacklab.wmdBase = function(){
	...
	var helpLink = "http://markdown.tw/";
	var helpHoverTitle = "Markdown help";
	...
	wmd.PanelCollection = function(){
		...
		this.input = doc.getElementById("wmd-input");
                ...
                if(! this.input) {
                    // in django admin
                    this.input = doc.getElementById('id_content');
                    this.input.id = 'wmd-input';
                    
                    this.buttonBar = doc.createElement('div');
                    this.buttonBar.id = "wmd-button-bar";
